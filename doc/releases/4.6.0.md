...
- Support MDict V3 format by updating `readmdict`, PR [#385](https://github.com/ilius/pyglossary/pull/385) by [@xiaoqiangwang](https://github.com/xiaoqiangwang)
...
## XDXF: fixes / improvements, issue [#376](https://github.com/ilius/pyglossary/issues/376)
...
- Update and refactor `Dockerfile` and `run-with-docker.sh`
  ...
  - Reuse existing docker image with same tag
